...
def run_full_pipeline(speaker_name=None, meas_paths=None, noise_path=None,
    ...
    for rate in rates:
        ...
        # 5. Store per-rate results — float biquad coefficients directly
...
def main():
    ...
    if args.command == "setup":
        ...
        eq_freqs, biquads_44, biquads_48, bands_44, bands_48, cfg, coeffs_flat, fft_gains_44, fft_gains_48 = result
