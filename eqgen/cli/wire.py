...
def _fit_and_quantize(eq_freqs, shifted_db, design_fs, max_bands):
    """Fit biquads at design_fs, quantize, return (bq_q28, bands, fitted_db)."""
    ...
    # Reconstruct float representation for error analysis
    q28_floats = [
    ...
    return bq_q28, fit.bands, fitted_db
...
def run_full_pipeline(speaker_name=None, meas_paths=None, noise_path=None,
    ...
    # Fit at both 44100 Hz and 48000 Hz
    rates = [44100.0, 48000.0]
    all_bq_q28 = {}
    all_bands = {}
    for rate in rates:
        print(f"\n── Fitting IIR biquads at {rate:.0f} Hz (max {max_bands} bands)...")
        bq_q28, bands, fitted_db = _fit_and_quantize(
            eq_freqs, shifted_db, float(rate), max_bands)
    ...
    return eq_freqs, bq_q28_44, bq_q28_48, bands_44, bands_48, cfg, coeffs_flat
...
def main():
    ...
    if args.command == "setup":
        ...
        eq_freqs, bq_q28_44, bq_q28_48, bands_44, bands_48, cfg, coeffs_flat = result
        ...
        eq_freqs, bq_q28_44, bq_q28_48, bands_44, bands_48, cfg, coeffs_flat = run_full_pipeline(
            meas_paths=args.measurement, noise_path=args.noise,
            target_path=args.target, fc=args.fc, h2=args.h2, h3=args.h3,
            smooth_exponent=args.smooth_exponent, max_bands=args.max_bands,
            bluetooth_id=args.bluetooth_id,
