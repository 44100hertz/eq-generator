...
# Add the python/ directory to sys.path so modules can import each other
...
MODULES = {
    ...
    "harmonics":   ("tests.test_harmonics",   "Harmonic purity & linearity"),
    "compressor":  ("tests.test_compressor",  "Compressor & dynamics"),
    "gain_safety": ("tests.test_gain_safety", "Gain safety on real measurements"),
    "chebyshev":   ("tests.test_chebyshev",   "Chebyshev math analysis"),

    # Model tests — verify the psychoacoustic model
    "model":       ("tests.test_model",       "Model verification (DSP vs formula)"),
    "loudness":    ("model",                  "Equal-loudness weighting"),
    "model_gain":  ("model",                  "Model gain analysis"),
}
